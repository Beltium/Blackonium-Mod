...
package mc.beltium.blackoniummod.gui;
...
import mc.beltium.blackoniummod.procedure.ProcedureCompressorGuiProssedure;
...
public class GuiGuiCompressor extends ElementsBlackoniumMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiGuiCompressor(ElementsBlackoniumMod instance) {
		super(instance, 39);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				BlackoniumMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("blackoniummod:textures/guicompressor.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			BlackoniumMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ProcedureCompressorGuiProssedure.executeProcedure($_dependencies);
			}
		}
