 ...
 *
 *    Keep the ElementsBlackoniumMod object in this class and all calls to this object
...
public class BlackoniumMod {
	...
	@Mod.Instance(MODID)
	public static BlackoniumMod instance;
	public ElementsBlackoniumMod elements = new ElementsBlackoniumMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsBlackoniumMod.GuiHandler());
