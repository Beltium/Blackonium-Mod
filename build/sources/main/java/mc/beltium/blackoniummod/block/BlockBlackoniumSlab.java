...
public class BlockBlackoniumSlab extends ElementsBlackoniumMod.ModElement {
	@GameRegistry.ObjectHolder("blackoniummod:blackoniumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("blackoniummod:blackoniumslab_double")
	public static final Block block_slab_double = null;
	public BlockBlackoniumSlab(ElementsBlackoniumMod instance) {
		super(instance, 51);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("blackoniumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("blackoniumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("blackoniummod:blackoniumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("blackoniumslab");
